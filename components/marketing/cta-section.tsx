...
export function CtaSection() {
  ...
  return (
    <SectionShell id="book-demo">
      <Reveal>
        <div className="overflow-hidden rounded-[36px] border border-white/10 bg-[linear-gradient(135deg,#fff7f1_0%,#ffffff_40%,#fff4eb_100%)] px-6 py-12 shadow-premium sm:px-10 sm:py-14 lg:px-14">
